...
imiss <- read.table("data_miss_chrX.imiss",header=T)
het <- read.table("data_het_chrX.het",header=T)
...
pdf("pairs.imiss-vs-het_chrX.pdf")
...
write.csv(output_3sd, "het_output_3sd_chrX.csv", row.names = FALSE)